...
const VerNotasAluno = ({ alunoId, turmaId, materiaId }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-semibold mb-4">Notas do Aluno</h2>
